...
import { checkWeatherMatchesConstraints } from "../src/weatherFunctions";
import { expect, jest, test } from "@jest/globals";
import { WeatherConstaint, Weather } from "../../types/weatherTypes";
...
test("test if wind speed in correct range gives true", () => {
    ...
    const result = checkWeatherMatchesConstraints(
        constraintTestValues,
        weatherTestValues
    );
